...
function changeRat()
	...
	for r in [0.0001, 0.0005, 0.001, 0.005, 0.01, 0.05]
		...
		ratR = [lG[g]/cenR[g] for g in 1:om]
		ratF = [lG[g]/cenF[g] for g in 1:om]
		ratO = [lG[g]/cenO[g] for g in 1:om]
		ratB = [lG[g]/cenB[g] for g in 1:om]

		push!(dispR, maximum(ratR)/minimum(ratR))
